...
Бот в Telegram и мини-приложение — один проект: бота находят по имени **[@findorigin_bot](https://t.me/findorigin_bot)**, веб-интерфейс (Mini App) — по адресу **`https://<ваш-проект>.vercel.app/tma`** (кнопка меню в чате с ботом или прямая ссылка).
